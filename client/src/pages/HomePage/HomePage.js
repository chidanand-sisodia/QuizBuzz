  ...
  return (
    <div className="home-container">
      <div className="hero-section">
        ...
        <p className="animated-description">Craft engaging quizzes in minutes, gauge knowledge effortlessly.</p>
        <button className="cta-button" onClick={handleCreateQuizClick}>Create Quiz</button>
        <button className="cta-button" onClick={handleDemoClick}>Take a Demo</button>
